...
class direccionDB {
    ...
    public function verDireccion($Codigo_persona) {
        ...
        try {
            $dbCon = getConnection();
            $sql1 = "SELECT dir.`Id_direccion`, per.`Codigo_persona`, dir.`direccion`, per.`Nombres`, per.`Apellidos`"
            ...
            if (!empty($datosDireccion['Codigo_persona'])) {
                ...
                $direccion["direccion"] = utf8_encode($datosDireccion['direccion']);
    ...
    public function crearDireccion($Id_direccion, $Codigo_persona, $direccion, $estado) {
        try {
            $dbCon = getConnection();
            $sql= "INSERT INTO `direccionpersona`(`Codigo_persona`, `Id_direccion`, `direccion`, `estado`) VALUES ('" . $Id_direccion . "','" . $Codigo_persona . "',"
                    . "'" . $direccion . "','" . $estado . "');";
